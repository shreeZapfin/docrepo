...
class PickupController extends Controller
{
    ...
    public function index(Request $request){
        ...
        return view('backEnd.pickups.index',compact('GeneralWebmasterSections','agents','status'));
    }

    //Display Pickups Data
    public function data(Request $request){
        ...
        $query = Pickup::join('customers','customers.id','pickups.customer_id')
            ...
            'pickups.pickup_date',
            'customers.name as customer','customers.company_name','agents.name as agent_name','company_products.name as job','pickups.id','pickups.application_id'));
    ...
    public function edit($id)
    {
        ...
        if (!empty($Pickups)) {
                ...
                $customers = Customer::get();
                $agents  = Agent::get();
                return view("backEnd.pickups.edit",
                    compact( "link_availble","GeneralWebmasterSections","Pickupschedules", "document_submit_date","Docpictures","Pickups","submited_doc", "pickup_documents","products","customers","agents","submited_documents"));
            } else {
                return redirect()->action('PickupController@index');
            }
    }
