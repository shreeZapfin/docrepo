...
class UsersController extends Controller
{
    ...
    {
//        $pickupId = 193;
//        $emailJob = (new ProcessPodcast($pickupId))->delay(Carbon::now()->addSeconds(3));
//        $demo = dispatch($emailJob);

//        $submited_documents = PickupDocument::where('pickup_id',193)
...
//            ->where('id',193)->first(array('agent_id','completed_at','pod_number'));
...
//        $pdf->save(public_path() . '/downloads/' . 'Pickup'.'.pdf');
//
//        $data = new \stdClass();
//        $data->name = "pooja";
//        $data->pdf =
//        $data->forgotPasswordUrl = URL::route('forgot-password-confirm', [1, 1]);
//        $file = public_path() . '/downloads/' . 'Pickup'. '.pdf';
