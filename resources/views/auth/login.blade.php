...
<head>
    ...
    <title>{{ trans('backLang.control') }} | Login</title>
</head>
<body>
<div class="app" id="app">
    {{--<img src="{{ URL::to('backEnd/assets/images/business.png') }}"  class="img-responsive mar">--}}
    <!-- ############ LAYOUT START-->
    <div class="center-block w-xxl w-auto-xs p-y-md">
        ...
        <div class="p-a-md box-color r box-shadow-z1 text-color">
            <div class="m-b text-sm" style="font-size: 1rem;">
            ...
            <a href="{{route('customerHome')}}" class="btn warning btn-block p-x-md m-b">{{ trans('backLang.go_to_customer') }}</a>
        </div>
    </div>
    <!-- ############ LAYOUT END-->
</div>
